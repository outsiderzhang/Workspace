...
{
    [self setAssociatedObject:__tt_tipview_userData forKey:@"__tt_tipview_userData" association:ZRAssociationStrong isAtomic:NO];
}
...
{
    [self setAssociatedObject:__tt_tipview_retryAction forKey:@"__tt_tipview_retryAction" association:ZRAssociationStrong isAtomic:NO];
}
...
{
    [self setAssociatedObject:tt_tipView forKey:@"__tt_tipView" association:ZRAssociationStrong isAtomic:NO];
}
- (UIView *)tt_tipView
{
