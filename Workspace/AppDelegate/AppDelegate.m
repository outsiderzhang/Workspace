...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions {
    ...
    //初始化配置信息
    ZRConfig *config = [ZRConfig config];
    
    ZRTabBarController *tabBarVc = [[ZRTabBarController alloc] initWithTabBarControllers:controllersArr norImages:imageNormalArr selImages:imageSelectedArr titles:titleArr config:config];
